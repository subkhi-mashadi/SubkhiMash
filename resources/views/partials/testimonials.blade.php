...
<section id="testimonials" class="py-24 border-t border-neutral-200 dark:border-white/5">
    <div class="max-w-6xl mx-auto px-6">
        <p class="reveal text-indigo-500 dark:text-indigo-400 font-medium mb-2 text-center">{{ __('portfolio.testimonials.label') }}</p>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            @foreach ($testimonials as $t)
                <figure class="reveal rounded-2xl border border-neutral-200 dark:border-white/10 bg-white dark:bg-neutral-900/40 p-6 flex flex-col">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-indigo-400 mb-4" fill="currentColor" viewBox="0 0 24 24">
