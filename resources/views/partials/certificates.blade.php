...
<section id="certificates" class="py-24 border-t border-neutral-200 dark:border-white/5">
    <div class="max-w-6xl mx-auto px-6">
        <p class="reveal text-indigo-500 dark:text-indigo-400 font-medium mb-2 text-center">{{ __('portfolio.certificates.label') }}</p>
