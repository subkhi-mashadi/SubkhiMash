...
<section id="skills" class="py-24 bg-indigo-50 dark:bg-neutral-900/30">
    <div class="max-w-6xl mx-auto px-6">
        <p class="reveal text-indigo-600 dark:text-indigo-400 font-medium mb-2 text-center">{{ __('portfolio.skills.label') }}</p>
